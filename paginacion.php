...
<div class="container">
  ...
  <div class="row">
    <div class="col-md-12">
      <h3>REGISTROS GUARDADOS TABLA 1</h3>
    </div>
  </div>
...
$query = "SELECT * FROM tabla1 order by id ASC LIMIT $start_from, $registro_por_pagina";
...
<div class="table-responsive">
    ...
    <br />
    <?php
    $page_query = "SELECT * FROM tabla1 ORDER BY id DESC";
